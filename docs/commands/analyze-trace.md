---
title: "/analyze-trace — Slash Command for AI Coding Agents"
description: "Analyze a ReAct execution trace JSON file for reasoning loop pathologies (D1-D7) and recommend specific loop-engineering mitigations. Usage. Slash command for Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/commands\analyze-trace.md">Source</a></span>
</div>
