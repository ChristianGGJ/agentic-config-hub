---
title: "Self-Eval: Honest Work Evaluation — Prompts Optimization & Quality Rubrics"
description: "Use when you need an honest, calibrated evaluation of AI work quality after completing a task, code review, or work session -- rates task ambition. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/self-eval/SKILL.md">Source</a></span>
</div>
