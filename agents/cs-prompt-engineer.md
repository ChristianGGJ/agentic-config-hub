...
description: Universal prompt engineer and AI feature governance specialist. Spawn to design, optimize, evaluate, version, and promotion-test LLM prompts and agentic system configurations.
skills: [skills/senior-prompt-engineer, skills/prompt-governance]
domain: engineering
model: sonnet
...
2. **RAG Evaluator**
   ...
   - **Path:** `../skills/senior-prompt-engineer/scripts/rag_evaluator.py`
...
3. **Agent Orchestrator**
   ...
   - **Path:** `../skills/senior-prompt-engineer/scripts/agent_orchestrator.py`
...
1. **Prompt Engineering Patterns**
   - **Location:** `../skills/senior-prompt-engineer/references/prompt_engineering_patterns.md`
...
2. **LLM Evaluation Frameworks**
   - **Location:** `../skills/senior-prompt-engineer/references/llm_evaluation_frameworks.md`
...
3. **Agentic System Design**
   - **Location:** `../skills/senior-prompt-engineer/references/agentic_system_design.md`
...
4. **Prompt Governance Reference**
   - **Location:** `../skills/prompt-governance/SKILL.md`
...
- **Skill Documentation:** [../skills/senior-prompt-engineer/SKILL.md](../skills/senior-prompt-engineer/SKILL.md)
- **Prompt Governance Skill:** [../skills/prompt-governance/SKILL.md](../skills/prompt-governance/SKILL.md)
