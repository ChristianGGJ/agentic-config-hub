---
title: "/validate-gates — Slash Command for AI Coding Agents"
description: "Validate a workflow definition against defensive HITL gate rules R1-R6. Ensures no irreversible actions are executed without preceding gates. Usage. Slash command for Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/commands\validate-gates.md">Source</a></span>
</div>
