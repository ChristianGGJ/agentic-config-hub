...
description: "Use when instrumenting agentic systems for observability: OpenTelemetry tracing of the chat client itself, structured logging with correlation IDs, LangSmith/AgentOps backends, and hub-canon agent-loop telemetry (iterations, delegation depth, which exit condition fired) so you can see WHY an agent stopped."
---
