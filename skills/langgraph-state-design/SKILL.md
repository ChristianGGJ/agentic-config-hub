...
description: "Use when designing LangGraph StateGraphs: typed state schemas and reducers, conditional edge routing, Command/Send handoffs, checkpointers and time travel, interrupt-based human gates, or bounding cyclic graphs against runaway recursion."
---
