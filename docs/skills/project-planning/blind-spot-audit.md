---
title: "Blind-Spot Audit: Omission and Hidden-Prerequisite Detection — Project Planning & Requirements Elicitation"
description: "Use when auditing a project idea/brief or a draft plan.json for blind spots before planning proceeds - scanning the artifact against domain-profile. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-identifier: `blind-spot-audit`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/blind-spot-audit/SKILL.md">Source</a></span>
</div>
