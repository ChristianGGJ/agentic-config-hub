...
description: "Use when designing agent memory: short-term thread state vs long-term stores, vector DB schemas (pgvector/Qdrant/Azure AI Search), hybrid BM25+dense. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
