...
description: "Use when integrating Microsoft Agent Framework agents into enterprise ASP.NET Core/.NET applications: DI lifetimes and keyed agent registration, exposing business services as AIFunction tools, EF Core data access for tools, IOptions/secrets configuration, built-in OpenTelemetry, resilience policies, and hosted or streaming agent endpoints."
---
