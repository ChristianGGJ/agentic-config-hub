---
title: "Stakeholder-Inference: From Brief to Classified Stakeholder Register — Project Planning & Requirements Elicitation"
description: "Use when a project brief or scope description must be turned into a classified stakeholder register - inferring users, operators, suppliers. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-identifier: `stakeholder-inference`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/stakeholder-inference/SKILL.md">Source</a></span>
</div>
