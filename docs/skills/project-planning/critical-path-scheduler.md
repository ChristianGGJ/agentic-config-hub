---
title: "Critical-Path Scheduler — Project Planning & Requirements Elicitation"
description: "Use when a task plan with depends_on links and working-day durations needs calendar dates -- validates the dependency graph (cycles with the path. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-identifier: `critical-path-scheduler`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/critical-path-scheduler/SKILL.md">Source</a></span>
</div>
