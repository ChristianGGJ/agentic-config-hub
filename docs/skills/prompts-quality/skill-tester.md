---
title: "Skill Tester — Prompts Optimization & Quality Rubrics"
description: "Use when validating, testing, or quality-scoring a skill package before publishing: check SKILL.md structure and frontmatter canon, run a skill's. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/skill-tester/SKILL.md">Source</a></span>
</div>
