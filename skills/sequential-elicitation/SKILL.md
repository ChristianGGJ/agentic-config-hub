---
name: "sequential-elicitation"
description: "Use when an underspecified idea or brief must become a validated scope record through a bounded two-way dialogue -- one question at a time derived from the prior answer, coverage tracked in an append-only JSONL ledger, and a deterministic governor deciding continue-or-stop against the hub six-type exit-condition taxonomy."
---
