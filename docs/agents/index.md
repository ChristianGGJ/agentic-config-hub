...
-   :material-robot:{ .lg .middle } **[Agent Designer](cs-agent-designer.md)**

    ---

    Role-bound Agentic Orchestrator

-   :material-robot:{ .lg .middle } **[Agent Security Auditor](cs-agent-security-auditor.md)**
...
-   :material-robot:{ .lg .middle } **[Prompt Engineer](cs-prompt-engineer.md)**
