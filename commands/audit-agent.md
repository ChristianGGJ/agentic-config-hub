...
name: audit-agent
description: |
  Audit an agent configuration against the loop-engineering rubric (100 points, categories A-E)
  and remediate failed checks until it scores >=90 HARDENED. Bounded at 3 remediation cycles,
  then escalates to the user. Usage: /audit-agent <agent-path>
---
