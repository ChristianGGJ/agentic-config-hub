---
name: "slip-driven-replanning"
description: "Use when a confirmed schedule slip must become a replan decision - inject reported delays into a plan for a CPM recompute, diff the baseline schedule against the recomputed one for finish deltas, critical-path changes, and milestone breaches, then select absorb / compress / escalate with a drafted notification before the human approval gate."
---
