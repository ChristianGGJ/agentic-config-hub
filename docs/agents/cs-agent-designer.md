---
title: "Agent Designer — AI Coding Agent"
description: "Universal agent designer and multi-agent system architect. Spawn to design multi-agent communication patterns, draft tool schemas, and evaluate agent. Agent-native orchestrator for Claude Code."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/agents\cs-agent-designer.md">Source</a></span>
</div>
...
**Skill Location:**
- [`skills\agent-designer`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer)

### Python Tools

1. **Agent Planner**
   - **Purpose:** Decomposes system requirements into structured multi-agent architecture plans.
   - **Path:** [`skills\agent-designer\agent_planner.py`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\agent_planner.py)
...
2. **Tool Schema Generator**
   ...
   - **Path:** [`skills\agent-designer\tool_schema_generator.py`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\tool_schema_generator.py)
...
3. **Agent Evaluator**
   ...
   - **Path:** [`skills\agent-designer\agent_evaluator.py`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\agent_evaluator.py)
...
1. **Agent Architecture Patterns**
   - **Location:** [`skills\agent-designer\references\agent_architecture_patterns.md`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\references\agent_architecture_patterns.md)
...
2. **Tool Design Best Practices**
   - **Location:** [`skills\agent-designer\references\tool_design_best_practices.md`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\references\tool_design_best_practices.md)
...
3. **Evaluation Methodology**
   - **Location:** [`skills\agent-designer\references\evaluation_methodology.md`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\references\evaluation_methodology.md)
...
1. **Sample System Requirements**
   - **Location:** [`skills\agent-designer\assets\sample_system_requirements.json`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\assets\sample_system_requirements.json)
   - **Content:** Template representing typical functional requirements for a multi-agent system.
2. **Sample Tool Descriptions**
   - **Location:** [`skills\agent-designer\assets\sample_tool_descriptions.json`](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\assets\sample_tool_descriptions.json)
...
- **Skill Documentation:** [../skills/agent-designer/SKILL.md](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills\agent-designer\SKILL.md)
