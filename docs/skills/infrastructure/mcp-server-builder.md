...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/mcp-server-builder/SKILL.md">Source</a></span>
</div>
...
- [references/validation-checklist.md](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/mcp-server-builder/references/validation-checklist.md)
- [README.md](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/mcp-server-builder/README.md)
