---
title: "Agent Workflow Designer — Core Agentic Design & Loop Safety"
description: "Use when designing multi-step agent workflows: selecting a workflow pattern (sequential, parallel, router, orchestrator, evaluator), defining typed. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/agent-workflow-designer/SKILL.md">Source</a></span>
</div>
