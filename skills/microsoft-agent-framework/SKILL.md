...
description: "Use when translating agentic-config-hub skills, agents, or workflows into Microsoft Agent Framework C# code (ChatClientAgent, AIFunction tools, Workflows), choosing a MAF orchestration pattern, or migrating Semantic Kernel / AutoGen code to the unified framework."
---
