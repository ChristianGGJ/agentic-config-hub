...
description: "Use when adding input/output/tool-call guardrails to an LLM application: Llama Guard moderation, Guardrails AI validators, Presidio PII redaction, prompt-injection defenses (spotlighting, sandwiching, dual-LLM), or when measuring guardrail effectiveness with FP/FN rates and threshold tuning."
---
