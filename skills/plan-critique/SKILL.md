---
name: "plan-critique"
description: "Use when a preliminary plan needs hostile pre-execution review before the human gate -- audits plan.json for missing lifecycle phases, basis-free estimates, single-point-of-failure owners, missing milestones, and duration outliers, lints the assumption register for evidence sources, invalidation tests, owners, and stale review dates, and returns severity-classified findings that each carry a concrete failure scenario."
---
