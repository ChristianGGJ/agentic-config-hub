...
[ecosystems/README.md](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/ecosystems/README.md).
...
Main requires PR approval; direct pushes are blocked. See [documentation/WORKFLOW.md](https://github.com/ChristianGGJ/agentic-config-hub/tree/main/documentation/WORKFLOW.md) for the full guide.
