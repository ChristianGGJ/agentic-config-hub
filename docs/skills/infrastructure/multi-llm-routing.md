---
title: "Multi-LLM Routing — MCP Servers & RAG Architectures"
description: "Use when deciding which LLM tier or model family should serve each task or agent node, designing cheap-first cascade routing with verified. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
