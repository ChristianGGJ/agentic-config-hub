---
title: "Plan Ticket Export — Project Planning & Requirements Elicitation"
description: "Use when an approved plan.json (hub canonical tasks: id, title, description, depends_on) must become offline, dependency-ordered, tool-specific. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-identifier: `plan-ticket-export`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/ChristianGGJ/agentic-config-hub/tree/main/skills/plan-ticket-export/SKILL.md">Source</a></span>
</div>
